// FIX_VERIFICADO_AO_ICONOS_PREMIUM
// AJUSTE_SOLICITADO_SOLO_ICONOS_POI_AO_202605
...
function detailActionIconSx(color: "blue" | "violet" = "blue") {
  const palette = color === "violet"
    ? { main: "#7c3aed", soft: "rgba(124,58,237,.12)", border: "rgba(124,58,237,.36)", shadow: "rgba(124,58,237,.22)" }
    : { main: "#2563eb", soft: "rgba(37,99,235,.12)", border: "rgba(37,99,235,.36)", shadow: "rgba(37,99,235,.22)" };
  ...
  return (
    <Box
      sx={{
        ...
        p: { xs: 2, md: 3 },
        background:
          "radial-gradient(circle at top left, rgba(59,130,246,.08), transparent 34%), linear-gradient(180deg, #f8fafc 0%, #ffffff 42%)",
      }}
    >
      {/* Header premium */}
      ...
      <Paper
        ...
        sx={{
          ...
          boxShadow: "0 20px 52px rgba(15,23,42,.08)",
        }}
      >
              ...
              return (
                <Paper
                  ...
                  sx={{
                    ...
                    background: open
                      ? "linear-gradient(180deg, rgba(250,245,255,.90), rgba(255,255,255,.98))"
                      : "linear-gradient(180deg, rgba(239,246,255,.70), rgba(255,255,255,.98))",
                    boxShadow: open ? "0 16px 36px rgba(124,58,237,.10)" : "0 14px 30px rgba(37,99,235,.07)",
                  }}
                >
                      ...
                      >
                        ...
                        {detail?.loading ? (
                          ...
                          <TableContainer component={Paper} elevation={0} sx={{ borderRadius: 2.5, border: "1px solid rgba(148,163,184,.28)", overflow: "hidden" }}>
                            <Table size="small">
                              <TableHead>
                                <TableRow sx={{ bgcolor: "rgba(124,58,237,.10)" }}>
                                      ...
                                      {d.idOeiAeiAo > 0 && (
                                        <Tooltip title="Ver unidades de medida" arrow>
                                          <IconButton
                                            ...
                                            sx={{ ...detailActionIconSx("violet"), ml: 0.75 }}
                                          >
