...
export default function PeiObjetivosAccionesIndicadoresPage() {
  ...
  const handleVolver = () => {
    ...
    const returnTo = sp.get("returnTo") || "/pei/oei";
    navigate(returnTo);
  };
  ...
  const saveAccion = async () => {
    ...
    try {
      ...
      const payload: AccionCreateUpdateDto = {
        ...
        descripcion: accionForm.enunciado.trim(),
        tipo: "INSTITUCIONAL",
        orden,
    ...
    <Box sx={pageBgSx}>
      ...
      <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 1.5 }}>
        <Box>
          <Typography sx={{ fontWeight: 1000, letterSpacing: 0.2 }}>
            {title}: O.E.I. / RESPONSABLES / A.E.I. / INDICADORES
          </Typography>
          <Typography sx={{ color: "text.secondary", fontSize: 13 }}>
            Visualiza acciones estratégicas institucionales e indicadores por OEI y Responsable.
          </Typography>
        </Box>
      ...
      <Paper sx={{ ...cardSx, mb: 2 }}>
        ...
        <Box sx={{ p: 2 }}>
          ...
          {!loading && !error && !vista && (
            <Alert severity="info">No se encontró la cabecera (OEI/Responsable).</Alert>
          )}
              ...
              <Table size="small">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell sx={thSx}>OBJETIVOS ESTRATÉGICOS INSTITUCIONALES</TableCell>
      ...
      <Paper sx={cardSx}>
        <Box sx={{ ...headerBarSx, justifyContent: "space-between" }}>
          <Box>
            <Typography sx={{ fontWeight: 1000 }}>
              PEI: ACCIONES ESTRATÉGICAS INSTITUCIONALES E INDICADORES
            </Typography>
            <Typography sx={{ color: "text.secondary", fontSize: 13 }}>
              Cada acción estratégica institucional puede tener uno o más indicadores.
            </Typography>
          </Box>
        ...
        <Box sx={{ p: 2 }}>
          {!filteredVista?.acciones?.length ? (
            <Alert severity="info">No hay acciones para este OEI/Responsable.</Alert>
          ) : (
            <TableContainer sx={{ borderRadius: 2, border: "1px solid #EEF2F7" }}>
              <Table size="small">
                <TableHead>
                  <TableRow>
                    <TableCell sx={thSx}>código</TableCell>
                    <TableCell sx={thSx}>ACCIONES ESTRATÉGICAS INSTITUCIONALES</TableCell>
