    ...
    <>
      ...
      >
        ...
        >
          <Stack spacing={0.55} sx={{ pr: 2, minWidth: 0 }}>
            <Stack direction="row" spacing={1} alignItems="flex-start" flexWrap="nowrap">
              <AttachFileRoundedIcon fontSize="small" sx={{ mt: 0.15, flexShrink: 0 }} />
        ...
        <DialogContent sx={{ pt: 2 }}>
            ...
            {loading ? (
              ...
              <Stack spacing={1.4}>
                <TextField
                  ...
                  size="small"
                  fullWidth
                  value={ficha?.nombreOriginal ?? "Aún no se ha adjuntado ficha"}
                  sx={fieldSx}
          ...
          >
            * La ficha se guarda por indicador dentro del OEI/AEI seleccionado. Al subir una nueva
